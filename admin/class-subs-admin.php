...
class Subs_Admin
{
	...
	function subs_add_settings_page()
	{
		...
		add_menu_page(
			...
			array($this,'subscription_render_settings_page'), // callback function
		...
		add_submenu_page(
			...
			array($this,'send_mail_cb') // Callback function that outputs the page HTML
		);
	}
